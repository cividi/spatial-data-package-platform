...
<i18n>
{
  "de": {
    ...
    "p.2":
      "Die Gemeindescan-Plattform ist Open Source und Open Development. Zum Gemeindescan beitragen: <a href=\"https://github.com/cividi/spatial-data-package-platform\" target=\"_blank\">Projekt auf GitHub</a>",
    "p.3":
