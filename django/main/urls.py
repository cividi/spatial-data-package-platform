...
from gsmap.views import CustomLoginView, logout, SnapshotFileUploadView, AnnotationCreateView,AnnotationUpdateView
...
urlpatterns = [
    ...
    path('api/v1/annotations/<str:annotation_id>/', AnnotationUpdateView.as_view()),
