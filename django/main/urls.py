...
from gsmap.views import CustomLoginView, logout, SnapshotFileUploadView, AnnotationView
...
urlpatterns = [
    ...
    path('api/v1/annotations/<str:annotation_id>/', csrf_exempt(AnnotationView.as_view())),
